/**
 * 检索测试套件
 * 测试 memory_search 和 vector_memory_search 工具
 */
    ...
    testCases: [
      ...
      // TC-060: 小数据量性能测试
      {
        ...
        execute: async (engine) => {
          ...
          return { result, duration, target: '< 100ms', passed: duration < 100 };
        },
      },
      ...
      // TC-061: 中等数据量性能测试
      {
        ...
        execute: async (engine) => {
          ...
          return { result, duration, target: '< 150ms', passed: duration < 150 };
        },
      },
    ],
  };
