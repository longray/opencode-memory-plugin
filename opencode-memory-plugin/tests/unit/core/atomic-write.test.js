...
describe('Atomic Write Module', () => {
  ...
  describe('atomicWriteText', () => {
    ...
    it('should handle EPERM on Windows by falling back to copy + unlink', () => {
      const testFile = path.join(tmpDir, 'test-eperm.txt');
      const content = 'eperm test';
      const tmpFile = testFile + '.tmp';
    ...
    it('should NOT use EPERM fallback on non-Windows platforms', () => {
      const testFile = path.join(tmpDir, 'test-eperm-linux.txt');
      const content = 'eperm linux test';
