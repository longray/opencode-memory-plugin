...
const runTests = () => {
  describe('Connection', () => {
    ...
    it('should receive session_id in connected message', async () => {
  ...
  describe('Heartbeat', () => {
    ...
    it('should keep connection alive by replying pong', async () => {
  ...
  describe('ReliableWebSocketClient', () => {
    it('should connect using our client library', async () => {
