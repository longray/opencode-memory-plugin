> ⚠️ **DEPRECATED**: This document has been migrated to `v3.3/architecture/ATOM-ARCHITECTURE.md`.
...
- [ ] 性能测试（大文件 > 100 Atom）⏳ PARTIAL（`tests/performance/context-budget-perf.test.js` 存在，但无专门的 Atom 大文件基准测试）
