...
# 验证安装
opencode
# 在OpenCode中使用 memory_write, memory_search, vector_memory_search 等工具
...
| 关键词搜索 | `memory_search` | 快速查找关键词 |
| 语义搜索 | `vector_memory_search` | 语义相关性搜索 |
...
| `memory_search` | 关键词搜索 | 在记忆中进行关键词匹配 |
| `vector_memory_search` | 语义搜索 | 使用向量相似度进行搜索 |
...
| memory_search | plugin.js | 关键词搜索工具 |
| vector_memory_search | plugin.js | 语义搜索工具 |
